...
export class MarketMostActive extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="Info-box" >
                <h3 className="Market-news-topic"><span className="star1">{"☆ "}</span>Most active</h3>
...
export default connect(mapState, mapDispatch)(MarketMostActive)